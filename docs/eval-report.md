...
Generated 2026-08-31 13:06 UTC · mode **offline** · model `fixtures (no model called)` · ambassador prompt `ec01c0073347`
...
**GATES BROKEN** — 66/68 scored cases pass (97%). Categories marked `gate` must pass at 100%: a single failure there is a client-facing incident (docs/05-).
