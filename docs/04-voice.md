...
| STT final after endpoint | 100-300ms | Qwen3-ASR transcribes the whole utterance on endpoint (ADR-015); no partials, so the transcript rail updates per turn; hosted latency measured day 1 |
